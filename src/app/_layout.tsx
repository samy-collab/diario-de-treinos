...
function AppNavigator() {
  ...
  if (isCheckingSession) return <View style={styles.loading}><ActivityIndicator color="#2563eb" size="large" /><Text style={styles.loadingText}>Verificando sua sessão...</Text></View>;

  return <Stack screenOptions={{ headerTintColor: '#1e3a8a', headerTitleStyle: { fontWeight: '700' } }}>
...
const styles = StyleSheet.create({ loading: { alignItems: 'center', backgroundColor: '#f8fafc', flex: 1, gap: 12, justifyContent: 'center' }, loadingText: { color: '#64748b' } });
